...
(define vim-keybindings
  (keymap
   (normal (l ":move-char-right-same-line")
           ...
           ;; NOTE: this implementation uses the f register
           ;; so be careful with saving other things there
           ;; TODO: implement this function once I figure
           ;; out how to set the proper register and replay
           ;; macros
   ...
   (select
    ...
    (% "match_brackets")
    ;; Estimation of Vim default repeat find keybind
    ;; inspired by this Helix discussion: https://github.com/helix-editor/helix/discussions/8311
    ("," "repeat_last_motion")
    ("=" ":reflow")
    (> (> "indent"))
    (< (< "unindent"))
